...
local function getReloadTimingFromParam(param)
    ...
    if (intro_empty == nil or intro == nil or loop == nil or ending == nil or ending_empty_feed == nil or loop_feed == nil) then
        return nil
    end
    return intro_empty, intro, loop, ending, ending_empty_feed, loop_feed
end

function M.tick_reload(api)
    -- Get all timings from script parameter in gun data
    local param = api:getScriptParams();
    local intro_empty, intro, loop, ending, ending_empty_feed, loop_feed = getReloadTimingFromParam(param)
